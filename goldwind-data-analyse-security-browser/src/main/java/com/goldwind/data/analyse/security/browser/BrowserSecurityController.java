package com.goldwind.data.analyse.security.browser;
...
import com.goldwind.data.analyse.security.core.bean.SimpleResponse;
...
public class BrowserSecurityController {
	...
	/**
	 * when need to login, redirect to this page.
	 * @param request
	 * @param response
	 * @return
	 */
